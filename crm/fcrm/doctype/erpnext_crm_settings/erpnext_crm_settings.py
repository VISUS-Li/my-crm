...
class ERPNextCRMSettings(Document):
	...
	def create_custom_fields_in_remote_site(self):
		...
		try:
			...
			frappe.msgprint(
				_(
					"Could not create the TripAI CRM custom fields on {0} automatically. "
					"If it is running the latest ERPNext, enable <b>TripAI CRM Data Synchronization</b> "
